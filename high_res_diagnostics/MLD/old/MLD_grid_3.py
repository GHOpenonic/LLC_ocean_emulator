"""
This script calculates mixed layer depth (MLD) per spatiotemporally averaged tile, on a face of LLC4320 data using MLD methods in:
...
def main():
   ...
   # stack dataset
    ...
    LLC_tile = LLC_tile.resample(time="MS").mean() # divide into monthly, take the mean
